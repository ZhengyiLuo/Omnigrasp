...
class HumanoidSoccer(humanoid_amp_task.HumanoidAMPTask):
    def __init__(self, cfg, sim_params, physics_engine, device_type, device_id, headless):
        ...
        self._strike_body_ids = self._build_key_body_ids_tensor(strike_body_names)
        ...
        self.warmup_time = int(5/self.dt)
        self.step_counter = 0
    ...
    def post_physics_step(self):
        ...
        self.step_counter += 1
        self.step_counter = torch.clamp(self.step_counter, 0, self.warmup_time + 1)
    ...
    def _compute_task_obs(self, env_ids=None):
        ...
        obs = compute_soccer_observations(root_states, tar_states)
        return obs
...
@torch.jit.script
def compute_soccer_observations(root_states, tar_states):
